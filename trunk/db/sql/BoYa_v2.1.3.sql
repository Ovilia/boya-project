/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     7/3/2011 4:41:17 PM                          */
/*==============================================================*/
...
(
   ...
   add_user             enum('Y','N'),
   delete_user          enum('Y','N'),
   modify_user          enum('Y','N'),
   query_user           enum('Y','N'),
   add_question         enum('Y','N'),
   delete_question      enum('Y','N'),
   modify_qustion       enum('Y','N'),
   query_question       enum('Y','N'),
